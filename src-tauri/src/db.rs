...
//!   - `migration.rs`   — CREATE_TABLES_SQL, column constants, migration v1-v10
//!   - `models.rs`      — serde DTOs (VideoInfo, UserInfo, TaskItem, etc.)
//!   - `query_builder.rs` — ColKind + build_upsert_sql()
//!   - `video_repo.rs`  — video_info CRUD
//!   - `user_repo.rs`   — user_info CRUD
//!   - `download_repo.rs` — live_records CRUD
